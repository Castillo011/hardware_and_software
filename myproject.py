...
def main():  # this is the main funcion this is the first think that run on my program 
    print ("Wealcome to the main menu of one complement calculator ") # I used the print stament to make the menu because is essay for me .
    ...
    if answer == "A": # if answare is A the program is going to call  decimal_to_binary  funtion 
      ...
      if(usrChoice == 1):
         ...
         print("Thank you for using the converter") # -1 is to quit the program 
      else:
         print("Wrong input going back to menu")
         return main() # any other input will give you a error mensagge and will send you back to the main fuction
       

    if answer == "B":  # if the user input for answere is B he chose binary to decimal
